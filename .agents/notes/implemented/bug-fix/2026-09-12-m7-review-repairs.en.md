...
4. **Metric names**: the kinds / minCounts check is `semanticExpectationCoverage`. Layout-label recall stays null without region-level truth. Later corrected to `paragraphLabelRecall` / `headingLabelRecall`; see [M8-pre review repairs](./2026-09-12-m8-pre-review-repairs.en.md).
